...
struct Tensor4D {
    ...
    Tensor4D &operator+=(Tensor4D const &others) {
        // TODO: 实现单向广播的加法
        ASSERT(shape[0] == others.shape[0] || others.shape[0] == 1, "Shape mismatch");
        ASSERT(shape[1] == others.shape[1] || others.shape[1] == 1, "Shape mismatch");
        ASSERT(shape[2] == others.shape[2] || others.shape[2] == 1, "Shape mismatch");
        ASSERT(shape[3] == others.shape[3] || others.shape[3] == 1, "Shape mismatch");
